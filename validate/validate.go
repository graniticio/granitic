...
will use to represent web service endpoints (see the package documentation for ws, ws/handler and https://granitic.io/ref/web-service-handlers )
...
The type is a shorthand for the the type of the field to be validated (see https://granitic.io/ref/validation )
...
https://granitic.io/ref/validation for more detail.
